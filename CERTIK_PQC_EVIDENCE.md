...
- `transferPayload` includes sender, recipient, amount, nonce, chainId, token, isoReference, and deadline.
- The Dilithium2 signature verifies authorization of the full `transferPayload`.
